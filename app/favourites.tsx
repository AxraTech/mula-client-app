...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: 14, fontFamily: "Poppins_600SemiBold", color: "#1A1A2E" },
  cardArtist: { fontSize: 12, fontFamily: "Poppins_400Regular", color: "#6B7280" },
  cardPrice: { fontSize: 13, fontFamily: "Poppins_600SemiBold", color: GOLD, marginTop: 2 },
  ...
  browseBtnText: { fontSize: 14, fontFamily: "Poppins_600SemiBold", color: "#FFFFFF" },
});
