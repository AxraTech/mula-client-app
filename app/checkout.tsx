...
const styles = StyleSheet.create({
  ...
  orderArtist: { fontSize: 13, marginTop: 2 },
  ...
  totalValue: { fontSize: 19, fontWeight: "700" },
  ...
  pmInfo: { flex: 1, gap: 2 },
  pmServiceName: { fontSize: 15 },
  pmReceiver: { fontSize: 13 },
  pmAccountRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  qrText: { fontSize: 17, fontWeight: "700" },
  qrSubtext: { fontSize: 14, textAlign: "center", lineHeight: 21 },
  phoneBox: {
    borderWidth: 1,
    borderRadius: 12,
    padding: 12,
  ...
  phoneNum: { fontSize: 19, fontWeight: "700" },
  phoneName: { fontSize: 13, marginTop: 2 },
  ...
  successTitle: { fontSize: 25, fontWeight: "700" },
  successMsg: { fontSize: 15, textAlign: "center", lineHeight: 23 },
  orderNumberBox: {
    borderWidth: 1,
    borderRadius: 12,
    padding: 12,
  ...
  orderNumLabel: { fontSize: 12, letterSpacing: 1 },
  orderNumValue: { fontSize: 23, fontWeight: "700", marginTop: 2 },
  deliveryInfo: { borderTopWidth: 1, width: "100%", paddingTop: 14, gap: 10 },
  deliveryRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  deliveryText: { fontSize: 14, flex: 1 },
  bottomBar: {
    position: "absolute",
    bottom: 0,
    left: 0,
